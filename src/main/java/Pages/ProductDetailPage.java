...
public class ProductDetailPage extends BaseStepMethod {
    ...
    private static final By BTN_PRODUCTDETAILPAGE_ONARIM_PAKETI_RED_BUTTON = By.xpath("//div[@data-test-class='modal_overflow']//div//div//h1//a");
    ...
    public void add_To_Cart(){
        hoverElement(BTN_PRODUCTDETAILPAGE_SEPETE_EKLE_SATICI2,5);
