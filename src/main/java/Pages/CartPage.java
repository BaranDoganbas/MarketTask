...
public class CartPage extends BaseStepMethod {
    ...
    private static final By TXT_CARTPAGE_PRODUCTS1_TITLES = By.xpath("(//div[@class='product_name_2Klj3']//a)[1]");
    private static final By TXT_CARTPAGE_PRODUCTS2_TITLES = By.xpath("(//div[@class='product_name_2Klj3']//a)[2]");
